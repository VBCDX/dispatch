...
export const ENDPOINTS: Endpoint[] = [
  ...
  { id: 'expire', method: 'POST', path: `${MSG}/expire`, group: 'Messages', auth: 'workspace', op: 'write', summary: 'Expire a message now', description: 'Anyone with write access in the workspace can expire any message they can reach — authorship grants nothing extra. Agents reach messages addressed to them; agent admins reach every message in the workspace. Undelivered receipts stay undelivered, a listener closes (410), a pending fire webhook won’t fire.', mcp: 'dispatch_expire', response: { id: 'msg_x7Kd2a', expires_at: '2026-09-24T12:30:00Z', never_delivered: 1 }, status: 200, errors: [404, 409], tryable: true },
