...
export const SCHEMAS: Record<string, object> = {
  ...
  MemberPatch: { type: 'object', minProperties: 1, properties: { role: { enum: ['admin', 'member'] }, read: { type: 'boolean', description: 'Agents only — humans always read. read: false also turns write off; write: true while read is off turns read on.' }, write: { type: 'boolean' } } },
